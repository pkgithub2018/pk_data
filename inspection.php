...
<body class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'la') ? 'lang-lao' : 'lang-en'; ?>">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="application.php?uid=<?php echo $userid; ?>&lang=<?php echo $lang; ?>">
  ...
  <main id="main" class="main">
   ...
   --> 
    ...
    <div class="pagetitle">
        <h1>Pest Detected Form</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo htmlspecialchars($mainHref); ?>">Home</a></li>
                <li class="breadcrumb-item"><a href="transaction.php?part=inspection&inspect=View/Edit&appid=<?php echo $appid; ?>&uid=<?php echo $userid; ?>">Inspection</a></li>
                <li class="breadcrumb-item active">Pest Detected</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Pest Detected Information</h5>
                        ...
                        <form id="pestDetectedForm" action="inspection.php?part=pest_detected&appid=<?php echo $appid; ?>&uid=<?php echo $userid; ?>" method="POST">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-light">
                                    <strong>Pest Information</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Select Pest <span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Infestation Level</label>
                                        <div class="col-sm-9">
                                            <select class="form-select" name="infestation_level">
                                                <option value="">Select level</option>
                                                <option value="trace" <?php if($infestation_level === 'trace') echo 'selected'; ?>>Trace</option>
                                                <option value="low" <?php if($infestation_level === 'low') echo 'selected'; ?>>Low</option>
                                                <option value="medium" <?php if($infestation_level === 'medium') echo 'selected'; ?>>Medium</option>
                                                <option value="high" <?php if($infestation_level === 'high') echo 'selected'; ?>>High</option>
                                                <option value="severe" <?php if($infestation_level === 'severe') echo 'selected'; ?>>Severe</option>
                                            </select>
                                        </div>
                                    </div>
                                    
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Alive Status</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Risk Category</label>
                                        <div class="col-sm-9">
                                            <select class="form-select" name="risk_category">
                                                <option value="">Select category</option>
                                                <option value="low" <?php if($risk_category === 'low') echo 'selected'; ?>>Low</option>
                                                <option value="medium" <?php if($risk_category === 'medium') echo 'selected'; ?>>Medium</option>
                                                <option value="high" <?php if($risk_category === 'high') echo 'selected'; ?>>High</option>
                                                <option value="critical" <?php if($risk_category === 'critical') echo 'selected'; ?>>Critical</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-light">
                                    <strong>Inspection Results and Measures</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Result Measure</label>
                                        <div class="col-sm-9" style="margin-top: 10px;">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="result_immediate_treatment" style="padding-left: 0.3em; vertical-align: middle;">
                                                    Immediately implement the treatment
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="result-measure-radio" type="radio" name="result_measure" 
                                                ...
                                                <label class="form-check-label" for="result_not_accordance" style="padding-left: 0.3em; vertical-align: middle;">
                                                    Regulated article was not accordance
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="result-measure-radio" type="radio" name="result_measure" 
          ...
          <div class="row">           
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title">Inspection List<span>| Recent</span></h5>
                ...
                <!-- treatement data table -->
                 <div class="card-body">
                  <h5 class="card-title">Treatment List<span>| Recent</span></h5>
                 </div>
              </div>
