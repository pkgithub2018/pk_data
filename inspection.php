...
if (!empty($userid)) {
 ...
 // Permission check for Inspection module (APP-INSPECT)
 $inspectPermit = UserPermitCheck($userid, 'PG-INSPECTION', $con);
 if (!$inspectPermit['pread']) {
    echo "<script>alert('Access Denied: You do not have permission to access the Inspection module.');</script>";
