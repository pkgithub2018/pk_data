...
<body>
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tables-data.html" class="active">
              <i class="bi bi-circle"></i><span>List of Users Group</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle d-flex justify-content-between align-items-center">
      ...
      <div>
        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addGroupModal">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" name="submitGroup" class="btn btn-success">Submit</button>
            </div>
            </form>
          </div>
        </div>
    ...
    <!-- Modal form submit -->
     <?php
      if (isset($_POST['submitGroup'])) {
        ...
        Groupnew($groupName,$groupDescription,$con); // Call the function to add new group
      }
    ?>
    <!-- End of Modal form submit -->
