  ...
  <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        async function syncApproverPosition() {
          ...
          // Get position from data-position attribute of selected option
          const selectedOption = approvedBySelect.options[approvedBySelect.selectedIndex];
          const position = selectedOption.getAttribute('data-position') || '';
          approverPositionInput.value = position;
        }
